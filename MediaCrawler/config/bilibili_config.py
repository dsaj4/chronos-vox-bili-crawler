...
# Maximum number of comments + sub-comments crawled per video
BILI_MAX_COMMENT_ITEMS_PER_VIDEO = 500

# Maximum number of sub-comments crawled per video
BILI_MAX_SUB_COMMENTS_PER_VIDEO = 50
